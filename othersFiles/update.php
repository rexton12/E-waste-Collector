		...
		<div class="col-md-9">
			<div class="contact-form">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">          
					    <input type="checkbox" name="wastetype[]" value="organic">Tv
                        <input type="checkbox" name="wastetype[]" value="inorganic">mobile
                        <input type="checkbox" name="wastetype[]" value="Household">radio
