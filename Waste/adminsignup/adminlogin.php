...
<div class="header">
            ...
            <div class="row">
                <div class="col-md-4 offset-md-4 form login-form">
                    <form action="index.php" method="POST" autocomplete="">
                        ...
                        <div class="form-group">
                            <input class="form-control button" style="background-color:green" type="submit" name="login" value="Login">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <p>E-Waste Collector | 2022 |<a href="../login-user.php"> <i class="fa fa-lock" aria-hidden="true"> Login As User</i></a>
